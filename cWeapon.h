...
public:
	...
	const char* audioItems[100] = {
		...
		"AUDIO_ITEM_COMPACTLAUNCHER",
		"AUDIO_ITEM_DB_SHOTGUN",
		"AUDIO_ITEM_DMRSNIPER",
		"AUDIO_ITEM_DOUBLEACTION_REVOLVER",
		"AUDIO_ITEM_EMP_LAUNCHER",
		"AUDIO_ITEM_FIREWORK",
		...
		"AUDIO_ITEM_HEAVY_RIFLE",
		"AUDIO_ITEM_HEAVYSNIPER",
		"AUDIO_ITEM_HEAVYSNIPER_MK2",
		"AUDIO_ITEM_HOMING_LAUNCHER",
		...
		"AUDIO_ITEM_MINISMG",
		"AUDIO_ITEM_MINIGUN",
		"AUDIO_ITEM_MISSILE_DEFENCE_CANNON",
		"AUDIO_ITEM_MOLOTOV",
		"AUDIO_ITEM_MP_RAILGUN",
		"AUDIO_ITEM_MUSKET",
		"AUDIO_ITEM_PISTOL",
		"AUDIO_ITEM_PISTOL50",
		"AUDIO_ITEM_PISTOL_MK2",
		"AUDIO_ITEM_PISTOL_XM3",
		...
		"AUDIO_ITEM_SM_VEHICLE_BOMBUSHKA_CANNON",
		"AUDIO_ITEM_SM_VEHICLE_HAVOK_MINIGUN",
		"AUDIO_ITEM_SM_VEHICLE_HUNTER_BARRAGE",
		"AUDIO_ITEM_SM_VEHICLE_HUNTER_CANNON",
		"AUDIO_ITEM_SM_VEHICLE_TULA_MG",
		"AUDIO_ITEM_SM_VEHICLE_WEAPON_MICROLIGHT_MG",
		"AUDIO_ITEM_SMG",
		"AUDIO_ITEM_SMG_MK2",
